...
import ExamSummary from './jamcand/ExamSummary';
      ...
      <div class="card-body">
        ...
        <div className="float-right mb-4">
          <button className="btn btn-danger">
            <Link to="/generalcbtlogin" className="text-white">Back</Link>
          </button>
        </div>
        ...
        <div className="text-center mt-4">
          ...
          <button className="btn btn-info" onClick={handleviewResult}>
           View Result
          </button>
